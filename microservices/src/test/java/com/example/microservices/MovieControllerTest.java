...
public class MovieControllerTest {
    ...
    @Test
    @Order(4)
    @DisplayName("List only actor object: ")
    public void listSingleActorObject(){
        String url = "/movies/list/id/onlyactor/{id}";
        String erg = "{\"id\":3, \"firstName\":\"Natalie\", \"lastName\":\"Portman\"}";
        Assertions.assertEquals(erg, get(url, 3).asString());
    }
    ...
    @Order(4)
    @DisplayName("List only actor object: ")
    public void listSingleRegisseurObject(){
        String url = "/movies/list/id/onlyregisseur/{id}";
        String erg = "{\"id\":1, \"firstName\":\"George\", \"lastName\":\"Lucas\"}";
        Assertions.assertEquals(erg, get(url, 1).asString());
    }
}
